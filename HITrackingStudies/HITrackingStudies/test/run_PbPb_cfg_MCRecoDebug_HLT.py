...
# Modify the Track collection to associate
...
process.tpRecoAssocGeneralTracks.associator = "quickTrackAssociatorByHitsTrackerHitAssociator"
...
process.HITrackCorrections.trackSrc = cms.InputTag("hltPFMuonMergingPPOnAA","","MYHLT")
...
# Modfy track collection to use
#process.anaTrack.trackSrc = 'generalTracks'
#process.anaTrack.mvaSrc = cms.InputTag("generalTracks","MVAValues")
process.anaTrack.trackSrc = cms.InputTag('hltPFMuonMergingPPOnAA','', 'MYHLT')
process.anaTrack.mvaSrc = cms.InputTag("hltPFMuonMergingPPOnAA","MVAVals", "MYHLT")
# I don't know MVA is correct in HLT..
...
process.hltMB.throw = cms.bool(True) # throw exception on unknown path names

process.p = cms.Path(
                      process.tpClusterProducer *
                      process.hltMB *
                      #process.quickTrackAssociatorByHits *
                      process.quickTrackAssociatorByHitsTrackerHitAssociator *
...
# Temporary  
process.source.fileNames = ['file:/eos/cms/store/group/phys_heavyions/soohwan/samples/HLTTracking/step3AOD_py_REPACK_RAW2DIGI_L1Reco_RECO.root']
