...
process.TFileService = cms.Service("TFileService",
                                   #fileName = cms.string('2023PbPb_RecoDebugMC_nhits0_noptResChi2Cut_CMSSW_14_0_12_hlt_Tracking_hltPFMuonMergingPPOnAA.root'))
                                   fileName = cms.string('/eos/cms/store/group/phys_heavyions/sayan/hlt_tracking_run3/2023PbPb_RecoDebugMC_nhits0_noptResChi2Cut_CMSSW_14_0_12_hlt_Tracking_hltPFMuonMergingPPOnAA.root')
)
                                   #fileName = cms.string('/eos/cms/store/group/phys_heavyions/rpradhan/TrackingStudies/2023PbPb_RecoDebugMC_nhits0_Test.root')
#)

process.load("SimTracker.TrackAssociation.trackingParticleRecoTrackAsssociation_cfi")
process.tpRecoAssocGeneralTracks = process.trackingParticleRecoTrackAsssociation.clone()
process.tpRecoAssocGeneralTracks.label_tr = cms.InputTag("generalTracks")
#process.tpRecoAssocGeneralTracks.label_tr = cms.InputTag("hltPFMuonMergingPPOnAA")
...
process.HITrackCorrections.trackSrc = cms.InputTag("hltPFMuonMergingPPOnAA")
if options.usePixelTrks == True:
...
if options.usePixelTrks == True:
    ...
    process.HITrackCorrections.ptErrMax = 99999999.0 # default 0.1
    process.HITrackCorrections.nhitsMin = 0 # default 0, 11
    process.HITrackCorrections.chi2nMax = 99999999.0 # 0.18
...
if (options.sample == "MC_MiniAOD" or options.sample == "MC_RecoDebug"):
    ...
    process.GlobalTag = GlobalTag(process.GlobalTag, '140X_mcRun3_2023_realistic_HI_v4', '')
...
process.anaTrack.trackSrc = 'hltPFMuonMergingPPOnAA'
process.anaTrack.mvaSrc = cms.InputTag("hltPFMuonMergingPPOnAA","MVAValues")
if options.usePixelTrks == True:
...
#process.hltMB.HLTPaths = ["DST_PFScoutingNoEle_ZeroBias_v2"]
process.hltMB.TriggerResultsTag = cms.InputTag("TriggerResults", "", "MYHLT")
process.hltMB.HLTPaths = ["DST_PFScoutingNoEle_ZeroBias_v*"]
#process.hltMB.HLTPaths = ["hltTriggerSummaryAOD"]
#process.hltMB.HLTPaths = ["HLT_HIMinimumBiasHF1ANDZDC1nOR_*"]
...
process.p = cms.Path(
    ...
    process.anaTrack ## comment if you want to save only histograms
)
